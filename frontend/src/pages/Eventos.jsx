    ...
    <div>
      ...
      >
        ...
        >
          ...
          <label htmlFor="checkCupo" style={{ fontSize: 14 }}>
        ...
        >
          {eventos.map((e) => (
            <div key={e.id} className="card">
              ...
              >
                ...
                <span
                  style={{
                    ...
                    borderRadius: 10,
                    background:
                      e.estado === "ACTIVO" ? "#1b4332" : "#4a0e0e",
                    color:
                      e.estado === "ACTIVO" ? "#8fecbb" : "#ff9b9b",
                  }}
                >
                  {e.estado}
                </span>
              ...
              <p style={{ margin: "10px 0", fontSize: 14, color: "#ccc" }}>
                {e.descripcion}
              </p>
              ...
              >
                ...
                <br />
                🏁 <b>Fin:</b>{" "}
                {new Date(e.fecha_fin).toLocaleString()}
              </div>
              ...
              <div style={{ marginBottom: 15 }}>
                ...
                >
                  <span>
                    Cupo: {e.cupo === 0 ? "Ilimitado" : e.cupo}
                  </span>
              ...
              {user.rol === "CLIENTE" &&
                e.estado === "ACTIVO" &&
                (e.cupo_disponible > 0 || e.cupo === 0) && (
                  <button
                    onClick={() => inscribirme(e.id)}
                    style={{
                      padding: 10,
                      width: "100%",
                      marginBottom: 8,
